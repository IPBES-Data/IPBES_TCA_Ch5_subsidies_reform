...
The file contains the `id`, `doi`, `author_abbr` and `abstract` of the papers.

The Excel file with a random sample of 50 papers can be downloded [here](random_50_subsidies.xlsx){target=_blank}. 
