...
#### Compound Sentiment per country
...
ggplot2::ggsave(
    file.path("maps", "sentiment_per_countries_all.pdf"),
    width = 12,
    height = 8,
    map
)
ggplot2::ggsave(
    file.path("maps", "sentiment_per_countries_all.png"),
    width = 12,
    height = 8,
    map
)
...
ggplot2::ggsave(
    file.path("maps", "sentiment_per_countries_10.pdf"),
    width = 12,
    height = 8,
    map_sel
)
ggplot2::ggsave(
    file.path("maps", "sentiment_per_countries_10.png"),
    width = 12,
    height = 8,
    map_sel
)
...
![](`r file.path("maps", "sentiment_per_countries_all.png")`)

To download high resolution, [click here](`r file.path("maps", "sentiment_per_countries_all.pdf")`){target="_blank"}

![](`r file.path("maps", "sentiment_per_countries_10.png")`)

To download high resolution, [click here](`r file.path("maps", "sentiment_per_countries_10.pdf")`){target="_blank"}

In the table, all countries are included

```{r}
data |> IPBES.R::table_dt(fn = "sentiment_per_countries")
rm(data)
```
