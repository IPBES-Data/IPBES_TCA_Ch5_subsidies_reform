...
figure <- readRDS(file.path("data", "ch_5_subsidies_reform", "publications_over_time.rds")) |>
    ...
    geom_line(aes(x = publication_year, y = p_cum / 5, color = "Cumulative proportion"), size = 1) +
    geom_line(aes(x = publication_year, y = p_oa_cum / 5, color = "Cumulative proportion OA"), size = 1) +
    #
